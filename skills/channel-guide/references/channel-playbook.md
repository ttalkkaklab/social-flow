...
produce 의 채널별 텍스트 저작, publish 의 승인 검토, content-reviewer 의 루브릭이
전부 이 문서를 기준으로 삼는다.

## §1 채널 결정 트리

소재 선별 게이트: ① 세 관문(새 정보 · 감정 자극 · 시의성) 중 1개 이상 통과
② 채널 적합성 — IG 는 "누가 이걸 저장하는가"에 답할 수 있어야 하고(체크리스트·
...
- 본문에 소제목·불릿 구조화 허용 — 4채널 중 정보 밀도가 가장 높다.
...
- [ ] 두 채널에 같은 문장이 그대로 들어가 있다 → 복붙 금지 위반
