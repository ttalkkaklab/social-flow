...
Ask for one of the `STYLES` presets (miniature, photoreal, webtoon, claymation, paper-cutout, ink-wash, toon-3d) and use the actual choice for all new storyboard images.
