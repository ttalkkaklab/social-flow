...
- **금지 소재**: <실존 인물·특정 장소 등 카테고리별 추가 금지>
...
| youtube | ✅/❌ | 쇼츠 — 로컬 업로드, 쿼터 일 6건 |

- **채널별 시그니처**: <해시태그 세트·CTA 문구 — 채널 문법 한도 내에서>
...
- 전체 보이스 목록은 `mcp__fect-mcp__tts_list_voices` 로 조회할 수 있다.
