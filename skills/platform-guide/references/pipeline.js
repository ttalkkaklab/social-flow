...
const GATES = [
  // ── Attended path ────────────────────────────────────────────────────
  {
    ...
    stage: 'drafted',
    checks: 'the human approves the storyboard, the six review results, and the money',
  ...
  },
  {
    ...
    checks: 'CONTENT_REVIEW tail shows copy ≥ 95 and P0 = 0 (max 3 rounds)',
  ...
  },
  {
    ...
    reviewer: 'content-reviewer',
    checks: 'content-reviewer copy ≥ 95 · P0 = 0 (max 2 rounds unattended)',
    onFail: 'queue_*: hold',
  },
  {
    id: 'spend',
  ...
  },
  {
    ...
    reviewer: 'storyboard-reviewer',
    mode: 'copy',
    checks: 'one round → P0 = 0 after the fixes',
