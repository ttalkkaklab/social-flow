...
- **도입부는 넷 중 하나로 연다 — 공포 · 공감 · 호기심 · 결말 미리 보여주기.**
  회차마다 이 중 하나는 반드시 쓴다(사용자 전달 크리에이터 강의, 2026-08-18). 첫 30초
  (커버 제목 + 세그① + 후킹)가 어느 자극으로 시청자를 멈춰 세우는지 저작 전에 한 줄로
  정하고, 커버 샷에 `hookType`(`fear`·`empathy`·`curiosity`·`spoiler`)으로 적는다.
