...
- **Skip them** and everything up to and including production still works. Research,
  ...
  aren't even listed (`tools/list` shows 72 instead of 98 — the 15 `portal_*` tools are
...
server. The 15 `portal_*` tools follow the same rule on the ttalkkakstory workspace key
