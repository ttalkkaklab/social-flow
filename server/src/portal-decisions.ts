...
export type PortalDecision = z.infer<typeof decisionSchema>;
...
export type PortalPublication = z.infer<typeof publicationSchema>;
/** The sidecar also works before scenes.js exists. Explicit arguments override the same file key. */
export function readDecisions(storyboardDir: string, explicit?: PortalDecision[]): PortalDecision[] {
