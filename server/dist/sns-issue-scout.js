...
export async function snsIssueScout(input) {
    ...
    return okJson({
        ...
        method: {
            ...
            scoring: 'Topic-phrase score = mention count × (1 + 0.25 × (platform count − 1)). A different yardstick from the YouTube scout\'s channel-median multiple, so never mix it into the same table',
