...
export const ROUTES = {
    ...
    instagram_publish: async (args) => {
        ...
        return fromApi(await sns.publishInstagram(input.videoUrl
            ...
            : { caption: input.caption, imageUrls: input.imageUrls }), SNS_PUBLISHED_NOTE);
    },
    facebook_publish: async (args) => {
        ...
        return fromApi(await sns.publishFacebook(input.videoUrl
            ? { caption: input.caption, videoUrl: input.videoUrl }
            : { caption: input.caption, imageUrls: input.imageUrls, linkUrl: input.linkUrl }), SNS_PUBLISHED_NOTE);
    },
