...
export const SNS_CHANNELS = ['THREADS', 'INSTAGRAM', 'FACEBOOK', 'YOUTUBE'];
export const snsCredentialFiles = {
...
export function requireGeminiKey() {
    if (!config.geminiApiKey) {
        throw new Error('GEMINI_API_KEY (or GOOGLE_API_KEY) is not set. veo_* video generation tools require a Gemini API key ' +
