...
import { checkedSpeechSchema, prepareGeneration, generateCheckedSpeech, characterErrorRate, reviewFailures, signalFailures, measureSignal } from '../dist/tts-quality.js';
